...
--
-- Hôte : mariadb:3306
-- Généré le : sam. 23 sep. 2023 à 04:44
...
('DoctrineMigrations\\Version20220627210844', '2023-09-23 06:20:35', 17),
('DoctrineMigrations\\Version20220628072050', '2023-09-23 06:20:35', 23),
('DoctrineMigrations\\Version20220628073104', '2023-09-23 06:20:35', 7),
('DoctrineMigrations\\Version20220628074353', '2023-09-23 06:20:35', 35),
('DoctrineMigrations\\Version20220628080048', '2023-09-23 06:20:35', 19),
('DoctrineMigrations\\Version20220628123805', '2023-09-23 06:20:35', 7),
('DoctrineMigrations\\Version20220629080846', '2023-09-23 06:20:35', 56),
('DoctrineMigrations\\Version20220629081608', '2023-09-23 06:20:35', 38),
('DoctrineMigrations\\Version20220630073041', '2023-09-23 06:20:35', 6),
('DoctrineMigrations\\Version20220630073056', '2023-09-23 06:20:35', 11),
('DoctrineMigrations\\Version20220630074108', '2023-09-23 06:20:35', 6),
('DoctrineMigrations\\Version20220701094524', '2023-09-23 06:20:35', 21),
('DoctrineMigrations\\Version20220705071738', '2023-09-23 06:20:35', 6),
('DoctrineMigrations\\Version20220706072235', '2023-09-23 06:20:35', 62);
...
CREATE TABLE `produits` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `achat_at` datetime DEFAULT NULL,
  `guarantee_at` datetime DEFAULT NULL,
  `price` int(11) NOT NULL,
  `content` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `active` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `manuel_src` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ticket_src` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lieu_achat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `produits` (`id`, `categories_id`, `users_id`, `name`, `slug`, `achat_at`, `guarantee_at`, `price`, `content`, `active`, `created_at`, `manuel_src`, `ticket_src`, `lieu_achat`) VALUES
...
(1, 'root@root.fr', '[\"ROLE_ADMIN\"]', '$2y$13$JoEos9jbRHE9sbuCRsEI6uPRoe0qH8YAirLui/2M4LFNjS7fDMqs2', 1, 'root', 'root'),
(2, 'contact@demo.fr', '[]', '$2y$13$bDazOHb8BV3AVIR58OJWfeTQ2MrMbK/hTGdYhToQZwVcv1/0Xpr/a', 1, 'Geoffroid', 'Vanessa');
...
ALTER TABLE `categories`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `categories` ADD FULLTEXT KEY `IDX_3AF346685E237E06` (`name`);
...
ALTER TABLE `produits` ADD FULLTEXT KEY `IDX_BE2DDF8C5E237E06FEC530A9` (`name`,`content`);
